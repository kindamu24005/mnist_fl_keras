...
x_train, x_no, y_train, y_no = train_test_split(x_train, y_train, train_size=500, random_state=2)
...
# モデル評価（スコア出力）
test_loss, test_acc = modelhundredth.evaluate(x_test, y_test, verbose=0)
...
plt.text(0.4, 1.11, "Hundredth data", fontsize="x-large")
